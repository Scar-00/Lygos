...
fn malloc(size: size_t) -> *i8;
fn realloc(ptr: *i8, size: size_t) -> *i8;
fn calloc(count: size_t, size: size_t) -> *i8;
fn free(block: *i8);
fn memcpy(dest: *i8, src: *i8, size: size_t) -> *i8;
fn memmove(dest: *i8, src: *i8, len: size_t) -> *i8;
